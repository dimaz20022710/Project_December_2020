...
class Unit(ABC):
    ...
    def __init__(self, hp, damage, movement, x, y, side, screen, cell_size, cells):
        ...
        self.hp = hp
        self.damage = damage
        self.movement = movement  # The radius within which the character can move
        self.x = x
        self.y = y
        self.pos = (x, y)
        self.side = side  # The side the character is playing on
        self.screen = screen
        self.cell_size = cell_size
        self.cells = cells  # A list in which all cells are written
        self.current_movement = movement
        self.current_hp = hp
        self.hit_status = 1  #
        self.current_damage = self.damage
        self.cooldown1 = 0  # Initial cooldown of 1 character ability
        self.cooldown2 = 0  # Initial cooldown of 2 character ability
        self.cooldown3 = 0  # Initial cooldown of 3 character ability
        self.cooldown4 = 0  # Initial cooldown of 4 character ability
        self.back_dmg = 0  # Initial return damage to the character
        self.clicked = False  # Initial state of pressing any button
        self.agred = 0
        self.stunned = 0
        self.protection = 0  # Hero's initial protection
        self.ability = 0
        self.ignore_walls = 0
